...
const ResultsScreen = ({ onHome, onRetry }) => {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#F7F9FC', fontFamily: 'Inter, sans-serif', color: '#1A2332' }}>
      <header style={{ background: '#fff', borderBottom: '1px solid #E4E8EF', padding: '16px 40px', display: 'flex', alignItems: 'center', gap: 16 }}>
      ...
      <main style={{ maxWidth: 1080, margin: '32px auto 60px', padding: '0 40px' }}>
        <Card padding={40}>
