          ...
          <div onClick={() => setShowPwd(false)} style={{ position: 'fixed', inset: 0, background: 'rgba(15,45,74,0.45)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 100, padding: 20 }}>
            <div onClick={e => e.stopPropagation()} style={{ background: '#fff', borderRadius: 14, padding: 28, maxWidth: 420, width: '100%' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                <input type="password" placeholder="Текущий пароль" style={{ padding: '12px 14px', border: '1px solid #E4E8EF', borderRadius: 8, fontSize: 15 }}/>
                <input type="password" placeholder="Новый пароль" style={{ padding: '12px 14px', border: '1px solid #E4E8EF', borderRadius: 8, fontSize: 15 }}/>
                <input type="password" placeholder="Повторите пароль" style={{ padding: '12px 14px', border: '1px solid #E4E8EF', borderRadius: 8, fontSize: 15 }}/>
              </div>
