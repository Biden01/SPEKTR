...
const DashboardScreen = ({ onStartTest, onLogout }) => (
  <div style={{ display: 'flex', minHeight: '100vh', fontFamily: 'Inter, sans-serif', background: '#F7F9FC', color: '#1A2332' }}>
    <Sidebar active="home" user={{ name: 'Иван Петров', id: '48213' }} />
    <main style={{ flex: 1, padding: '28px 40px 60px', overflow: 'auto' }}>
      <header style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 28 }}>
        <div>
          ...
          <div style={{ fontSize: 14, color: '#5B6778', marginTop: 4 }}>Электромонтёр 5 разряда · Участок № 3 · Таб. № 48213</div>
        </div>
