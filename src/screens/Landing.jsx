...
const LandingScreen = ({ onLogin, onStudy }) => (
  <div style={{ background: '#fff', minHeight: '100vh', fontFamily: 'Inter, sans-serif', color: '#1A2332' }}>
    ...
    {/* Hero */}
    <section style={{ position: 'relative', overflow: 'hidden', padding: '96px 40px 120px' }}>
      ...
      <div style={{ position: 'relative', maxWidth: 1280, margin: '0 auto', display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: 64, alignItems: 'center' }}>
        <div>
          ...
          <p style={{ fontSize: 18, color: '#5B6778', lineHeight: 1.6, margin: '24px 0 40px', maxWidth: 560 }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center' }}>
          <img src={MARK} style={{ width: 340, filter: 'drop-shadow(0 24px 56px rgba(27,75,122,0.18))' }} alt="" />
        </div>
      </div>
    </section>
    ...
    <section style={{ padding: '64px 40px' }}>
      <div style={{ maxWidth: 1280, margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 0, borderTop: '1px solid #E4E8EF', borderBottom: '1px solid #E4E8EF' }}>
        {[
          ...
          <div key={i} style={{ padding: '36px 24px', borderLeft: i ? '1px solid #E4E8EF' : 'none' }}>
            <div style={{ fontFamily: 'Manrope', fontWeight: 800, fontSize: 48, letterSpacing: '-0.025em', fontVariantNumeric: 'tabular-nums', color: '#1B4B7A' }}>{s.n}</div>
    ...
    {/* Footer */}
    <footer style={{ background: '#0F2D4A', color: '#fff', padding: '48px 40px 32px' }}>
      <div style={{ maxWidth: 1280, margin: '0 auto', display: 'grid', gridTemplateColumns: '1.2fr 1fr 1fr 1fr', gap: 40, alignItems: 'start' }}>
        <div>
      ...
      <div style={{ maxWidth: 1280, margin: '32px auto 0', paddingTop: 20, borderTop: '1px solid rgba(255,255,255,.08)', display: 'flex', justifyContent: 'space-between', fontSize: 12, color: '#8A95A5' }}>
