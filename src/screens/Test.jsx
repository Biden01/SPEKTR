...
const TestScreen = ({ onFinish, onBack }) => {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#F7F9FC', fontFamily: 'Inter, sans-serif', color: '#1A2332' }}>
      <header style={{ background: '#fff', borderBottom: '1px solid #E4E8EF', padding: '16px 40px', display: 'flex', alignItems: 'center', gap: 24 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, background: mins<5?'#FBECEC':'#F7F9FC', padding: '8px 14px', borderRadius: 8 }}>
      ...
      {/* Segmented progress */}
      <div style={{ padding: '16px 40px', background: '#fff', borderBottom: '1px solid #E4E8EF' }}>
        ...
        <div style={{ display: 'flex', gap: 3, marginTop: 6, fontSize: 11, color: '#5B6778' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '200px 1fr', gap: 32, padding: '32px 40px', maxWidth: 1280, margin: '0 auto' }}>
        {/* Question mini-map */}
        <aside>
        ...
        <section>
          <Card padding={36}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: 32, paddingTop: 24, borderTop: '1px solid #EEF1F6' }}>
